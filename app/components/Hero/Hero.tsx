                ...
                <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
                    ...
                    <div className="">
                        ...
                        <p className='mt-[1rem] text-white text-opacity-70 text-[18px]'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Error earum consequatur quibusdam debitis saepe at sit nam dolor ea rerum ipsum similique culpa, iusto repellendus odit vel quia. Molestias, veritatis.
                        </p>
                        <button className="mt-[2rem] px-8 py-3 sm:px-8 sm:py-3 text-[16px] 
                              sm:text-[16px] bg-blue-500 transition-all duration-200
                            hover:bg-green-600 flex items-center rounded-md text-white">
                            <span>
            ...
            <div className='w-[100%] h-[105vw] md:h-[70vw] lg:h-[50vw] flex items-center justify-center flex-col bg-blue-950 md:clip_path'>
                <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
                    ...
                    <div className="">
                        ...
                        <button className="mt-[2rem] px-8 py-3 sm:px-8 sm:py-3 text-[16px] 
                              sm:text-[16px] bg-green-500 transition-all duration-200
                            hover:bg-green-600 flex items-center rounded-md text-white">
                            <span>
                                <BiCycling className='w-[1.7rem] h-[1.7rem]' />
                            </span>
